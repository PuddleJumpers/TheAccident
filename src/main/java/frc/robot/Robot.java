...
public class Robot extends TimedRobot {
  ...
  private final PWMVictorSPX m_leftBack = new PWMVictorSPX(2);
  private final PWMVictorSPX m_rightFront = new PWMVictorSPX(1);
  private final PWMVictorSPX m_rightBack = new PWMVictorSPX(3);
  private final MotorControllerGroup leftside = new MotorControllerGroup(m_leftFront, m_leftBack);
  private final MotorControllerGroup rightside = new MotorControllerGroup(m_rightFront, m_rightBack);
